...
import static com.ozonehis.eip.odooopenmrs.route.OdooTestConstants.PATIENT_ID_UUID;
import static com.ozonehis.eip.odooopenmrs.route.OdooTestConstants.PATIENT_UUID;
import static com.ozonehis.eip.odooopenmrs.route.OdooTestConstants.URI_GET_ENTITY_BY_UUID;
import static com.ozonehis.eip.odooopenmrs.route.OdooTestConstants.URI_MOCK_GET_ENTITY_BY_UUID;
import static com.ozonehis.eip.odooopenmrs.route.OdooTestConstants.URI_PATIENT_ASSOCIATION_HANDLER;
...
public class OdooPatientAssociationHandlerRouteTest extends BaseOdooRouteTest {
    ...
    public void shouldLoadThePatientWhenProcessingPersonName() throws Exception {
        ...
        var personResource = singletonMap("uuid", personUuid);
        var nameResource = new HashMap<>();
