...
import com.ozonehis.eip.route.prp.BasePrpRouteTest;
...
public class GetObsByQnOnFormInVisitRouteTest extends BasePrpRouteTest {
    ...
    public void setup() throws Exception {
        ...
        advise(ROUTE_ID_GET_OBS_BY_QN_FORM_VISIT, new AdviceWithRouteBuilder() {
            ...
            public void configure() {
                ...
                interceptSendToEndpoint("direct:is-obs-form-validated-rule")
                        .skipSendToOriginalEndpoint()
    ...
    public void shouldReturnTheObsInTheVisitWithAMatchingTheConceptRecordedOnTheSpecifiedForm() throws Exception {
        ...
        mockGetEntityByUuidEndpoint.expectedPropertyValuesReceivedInAnyOrder(
                EX_PROP_RESOURCE_NAME, "visit", "encounter", "encounter");
        mockGetEntityByUuidEndpoint.expectedPropertyValuesReceivedInAnyOrder(
                EX_PROP_RESOURCE_ID, visitUuid, encUuid2, encUuid3);
        ...
        assertMessageLogged(
                Level.INFO, "Ignoring obs with uuid " + obsUuid1 + " recorded on a form that was not validated");
    }
}
