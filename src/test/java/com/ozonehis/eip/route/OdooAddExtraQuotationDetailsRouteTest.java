...
import static com.ozonehis.eip.route.OdooTestConstants.URI_ADD_EXTRA_QUOTATION_DETAILS;
    ...
    public void setup() throws Exception {
        ...
        advise(ROUTE_ID, new AdviceWithRouteBuilder() {
            ...
            public void configure() {
                weaveByToString(
                                "DynamicTo[{{openmrs.baseUrl}}/ws/rest/v1/obs?concept={{emr.weight.concept}}&patient=${exchangeProperty.patient.get('uuid')}]")
                        .replace()
