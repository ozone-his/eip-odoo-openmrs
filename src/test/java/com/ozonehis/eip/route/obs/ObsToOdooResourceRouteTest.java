...
@TestPropertySource(
        properties = "camel.springboot.xml-routes=classpath*:camel/obs/" + ROUTE_ID_OBS_TO_ODOO_RESOURCE + ".xml")
...
@TestPropertySource(
        properties = APP_PROP_NAME_OBS_TO_ODOO_HANDLER + "=" + ObsToOdooResourceRouteTest.ROUTE_OBS_TO_ODOO_RES_HANDLER)
