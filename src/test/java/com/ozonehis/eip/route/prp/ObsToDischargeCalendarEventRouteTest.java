...
import static com.ozonehis.eip.route.OdooTestConstants.APP_PROP_NAME_BASIC_SERVICE_PLAN_FORM_UUID;
...
import static com.ozonehis.eip.route.OdooTestConstants.APP_PROP_NAME_GRP_EXT_ID;
import static com.ozonehis.eip.route.OdooTestConstants.APP_PROP_NAME_ID_TYPE_UUID;
import static com.ozonehis.eip.route.OdooTestConstants.BASIC_SERVICE_PLAN_FORM_UUID;
...
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_PATIENT_TYPE;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_VALIDATED;
...
import static com.ozonehis.eip.route.OdooTestConstants.ROUTE_ID_GET_OBS_BY_QN_FORM_VISIT;
...
import static com.ozonehis.eip.route.OdooTestConstants.URI_GET_OBS_BY_QN_FORM_VISIT;
...
import static com.ozonehis.eip.route.prp.GetPartnerIdsByUserIdsRouteTest.PARAM_USER_IDS;
...
import com.ozonehis.eip.route.GetObsByQnOnFormInVisitRouteTest;
...
public class ObsToDischargeCalendarEventRouteTest extends BasePrpRouteTest {
    ...
    public void setup() throws Exception {
        ...
        advise(ROUTE_ID_OBS_TO_DISCHARGE_EVENT, new AdviceWithRouteBuilder() {
            ...
            public void configure() {
                ...
                interceptSendToEndpoint(URI_GET_OBS_BY_QN_FORM_VISIT)
                        .skipSendToOriginalEndpoint()
    ...
    public void shouldFailIfThePatientDoesNotExistInOpenmrs() throws Exception {
        ...
        mockGetEntityByUuidEndpoint.expectedPropertyValuesReceivedInAnyOrder(
                EX_PROP_IS_SUBRESOURCE, asList(false, false));
        mockGetEntityByUuidEndpoint.expectedPropertyValuesReceivedInAnyOrder(
                EX_PROP_RESOURCE_NAME, asList("encounter", "patient"));
        mockGetEntityByUuidEndpoint.expectedPropertyValuesReceivedInAnyOrder(
                EX_PROP_RESOURCE_ID, asList(encUuid, patientUuid));
    ...
    public void shouldFailIfNoDormitoryGroupIsFoundMatchingTheSpecifiedExternalId() throws Exception {
        ...
        mockGetEntityByUuidEndpoint.whenExchangeReceived(
                2, e -> e.getIn().setBody(mapper.writeValueAsString(patientRes)));
    ...
    public void shouldCreateTheCalendarEventInOdoo() throws Exception {
        ...
        final String expectedDescription =
                "Dear Dormitory Manager, episode of Service for " + fullName + " " + hsuId + " has been closed";
