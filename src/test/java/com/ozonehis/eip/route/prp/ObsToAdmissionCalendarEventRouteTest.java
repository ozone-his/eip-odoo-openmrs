...
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_INPATIENT;
...
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_YES;
...
public class ObsToAdmissionCalendarEventRouteTest extends BasePrpRouteTest {
    ...
    public void shouldCreateTheCalendarEventInOdoo() throws Exception {
        ...
        mockSaveCalendarEventEndpoint.expectedPropertyReceived(
                EX_PROP_SUBJECT, fullName + "/" + estimatedDays + " days");
        final String expectedDescription =
                "Service User " + fullName + " " + hsuId + " inpatient for estimated " + estimatedDays + " days";
