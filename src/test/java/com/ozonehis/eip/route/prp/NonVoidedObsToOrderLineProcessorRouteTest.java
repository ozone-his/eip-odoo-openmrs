...
import static com.ozonehis.eip.route.OdooTestConstants.EX_PROP_ORDER_LINE;
import static com.ozonehis.eip.route.OdooTestConstants.EX_PROP_QTY;
...
import static com.ozonehis.eip.route.OdooTestConstants.URI_MANAGE_ORDER_LINE;
...
public class NonVoidedObsToOrderLineProcessorRouteTest extends BasePrpRouteTest {
    ...
    public void shouldNotUpdateTheExistingLineIfQuantityHasNotChanged() throws Exception {
        ...
        mockManageLineEndpoint.assertIsSatisfied();
        assertMessageLogged(
                Level.INFO, "Item quantity is the same as that on the existing item in odoo, nothing to update");
    }
}
