...
import static com.ozonehis.eip.route.OdooTestConstants.EX_PROP_CREATE_QUOTE_IF_NOT_EXIST;
import static com.ozonehis.eip.route.OdooTestConstants.EX_PROP_ENTITY;
import static com.ozonehis.eip.route.OdooTestConstants.EX_PROP_LINE_CONCEPT;
import static com.ozonehis.eip.route.OdooTestConstants.URI_CONCEPT_LINE_PROCESSOR;
import static com.ozonehis.eip.route.OdooTestConstants.URI_FORM_VALIDATED_RULE;
import static com.ozonehis.eip.route.OdooTestConstants.URI_NON_VOIDED_OBS_PROCESSOR;
import static com.ozonehis.eip.route.OdooTestConstants.URI_OBS_TO_ORDER_LINE;
import static com.ozonehis.eip.route.OdooTestConstants.URI_UUID_TO_CUSTOMER;
...
@Ignore
@TestPropertySource(
        properties = "odoo.physio.session.concept.uuids=" + OdooObsToOrderLineRouteTest.CONCEPT_UUID_1 + ","
    ...
    public void setup() throws Exception {
        ...
        advise(ROUTE_ID, new AdviceWithRouteBuilder() {
            ...
            public void configure() {
                interceptSendToEndpoint(URI_VOIDED_OBS_PROCESSOR)
                        .skipSendToOriginalEndpoint()
                        .to(mockVoidedObsProcEndpoint);
                interceptSendToEndpoint(URI_NON_VOIDED_OBS_PROCESSOR)
                        .skipSendToOriginalEndpoint()
                        .to(mockNonVoidedObsProcEndpoint);
                interceptSendToEndpoint(URI_UUID_TO_CUSTOMER)
                        .skipSendToOriginalEndpoint()
                        .to(mockUuidToCustomerEndpoint);
                interceptSendToEndpoint(URI_CONCEPT_LINE_PROCESSOR)
                        .skipSendToOriginalEndpoint()
                        .to(mockOrderLineProcessorEndpoint);
                interceptSendToEndpoint(URI_FORM_VALIDATED_RULE)
                        .skipSendToOriginalEndpoint()
