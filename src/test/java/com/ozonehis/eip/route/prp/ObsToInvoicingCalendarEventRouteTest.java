...
import static com.ozonehis.eip.route.GetResourceByExtIdFromOdooRouteTest.PARAM_EXT_ID;
import static com.ozonehis.eip.route.OdooTestConstants.APP_PROP_NAME_CLOSE_EOS_CONCEPT;
import static com.ozonehis.eip.route.OdooTestConstants.APP_PROP_NAME_FINAL_ASSMT_CONCEPT;
import static com.ozonehis.eip.route.OdooTestConstants.APP_PROP_NAME_FINAL_ASSMT_FORM_UUID;
import static com.ozonehis.eip.route.OdooTestConstants.APP_PROP_NAME_ID_TYPE_UUID;
import static com.ozonehis.eip.route.OdooTestConstants.APP_PROP_NAME_INVOICE_GRP_EXT_ID;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_ASSMT_DECISION;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_CLOSE_EOS;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_PHYSIO_GRP_OTHER;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_PHYSIO_GRP_POST_AT;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_PHYSIO_GRP_PRE_AT;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_PHYSIO_IND_AT;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_PHYSIO_IND_NON_AT;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_SERVICE;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_SERVICE_CAT;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_SERVICE_CAT_AT;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_SERVICE_CAT_NON_AT;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_SERVICE_GRP_OTHER;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_SERVICE_GRP_POST;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_SERVICE_GRP_PRE;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_SERVICE_IND_NON_AT;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_SERVICE_IND_POST;
import static com.ozonehis.eip.route.OdooTestConstants.CONCEPT_UUID_SERVICE_IND_PRE;
...
import static com.ozonehis.eip.route.OdooTestConstants.EX_PROP_RES_REP;
import static com.ozonehis.eip.route.OdooTestConstants.FINAL_ASSMT_FORM_UUID;
import static com.ozonehis.eip.route.OdooTestConstants.MODEL_NAME_GROUPS;
import static com.ozonehis.eip.route.OdooTestConstants.PARAM_MODEL_NAME;
import static com.ozonehis.eip.route.OdooTestConstants.PHYSIO_FORM_UUID;
import static com.ozonehis.eip.route.OdooTestConstants.ROUTE_ID_GET_MOST_RECENT_ENC_BY_FORM_AND_VISIT;
import static com.ozonehis.eip.route.OdooTestConstants.ROUTE_ID_GET_PARTNERS_BY_USERS;
import static com.ozonehis.eip.route.OdooTestConstants.ROUTE_ID_GET_RES_BY_EXT_ID_FROM_ODOO;
import static com.ozonehis.eip.route.OdooTestConstants.ROUTE_ID_IS_ENC_VALIDATED;
import static com.ozonehis.eip.route.OdooTestConstants.ROUTE_ID_OBS_CAPTURED_ON_FORM;
import static com.ozonehis.eip.route.OdooTestConstants.ROUTE_ID_OBS_TO_INVOICE_EVENT;
import static com.ozonehis.eip.route.OdooTestConstants.ROUTE_ID_SAVE_CALENDAR_EVENT;
import static com.ozonehis.eip.route.OdooTestConstants.URI_GET_ENTITY_BY_UUID;
import static com.ozonehis.eip.route.OdooTestConstants.URI_GET_MOST_RECENT_ENC_BY_FORM_AND_VISIT;
import static com.ozonehis.eip.route.OdooTestConstants.URI_GET_PARTNERS_BY_USERS;
import static com.ozonehis.eip.route.OdooTestConstants.URI_GET_RES_BY_EXT_ID_FROM_ODOO;
import static com.ozonehis.eip.route.OdooTestConstants.URI_IS_ENC_VALIDATED;
...
import static com.ozonehis.eip.route.OdooTestConstants.URI_SAVE_CALENDAR_EVENT;
import static com.ozonehis.eip.route.OdooTestUtils.createCodedObs;
import static com.ozonehis.eip.route.OdooTestUtils.createEnc;
import static com.ozonehis.eip.route.OdooTestUtils.createNumericObs;
import static com.ozonehis.eip.route.OdooTestUtils.createPatientId;
import static com.ozonehis.eip.route.SaveCalendarEventInOdooRouteTest.EX_PROP_ATTENDEE_PARTNER_IDS;
import static com.ozonehis.eip.route.SaveCalendarEventInOdooRouteTest.EX_PROP_DESCRIPTION;
import static com.ozonehis.eip.route.SaveCalendarEventInOdooRouteTest.EX_PROP_DURATION;
import static com.ozonehis.eip.route.SaveCalendarEventInOdooRouteTest.EX_PROP_START;
import static com.ozonehis.eip.route.SaveCalendarEventInOdooRouteTest.EX_PROP_SUBJECT;
...
import com.ozonehis.eip.route.ObsCapturedOnFormRuleRouteTest;
...
@TestPropertySource(
        properties = APP_PROP_NAME_INVOICE_GRP_EXT_ID + "=" + ObsToInvoicingCalendarEventRouteTest.GRP_EXT_ID)
...
public class ObsToInvoicingCalendarEventRouteTest extends BasePrpRouteTest {
    ...
    private static final Map CAT_OBS_AT = createCodedObs(CONCEPT_UUID_SERVICE_CAT, CONCEPT_UUID_SERVICE_CAT_AT);

    private static final Map CAT_OBS_NON_AT = createCodedObs(CONCEPT_UUID_SERVICE_CAT, CONCEPT_UUID_SERVICE_CAT_NON_AT);
    ...
    public void setup() throws Exception {
        ...
        advise(ROUTE_ID_OBS_TO_INVOICE_EVENT, new AdviceWithRouteBuilder() {
            ...
            public void configure() {
                interceptSendToEndpoint(URI_OBS_CAPTURED_ON_FORM)
                        .skipSendToOriginalEndpoint()
                        .to(mockObsCapturedOnFormEndpoint);
                interceptSendToEndpoint(URI_IS_ENC_VALIDATED)
                        .skipSendToOriginalEndpoint()
                        .to(mockEncValidatedEndpoint);
                interceptSendToEndpoint(URI_GET_MOST_RECENT_ENC_BY_FORM_AND_VISIT)
                        .skipSendToOriginalEndpoint()
                        .to(mockGetMostRecentEncEndpoint);
                interceptSendToEndpoint(URI_GET_RES_BY_EXT_ID_FROM_ODOO)
                        .skipSendToOriginalEndpoint()
                        .to(mockGetResByExtIdEndpoint);
                interceptSendToEndpoint(URI_GET_PARTNERS_BY_USERS)
                        .skipSendToOriginalEndpoint()
                        .to(mockGetPartnersByUsersEndpoint);
                interceptSendToEndpoint(URI_SAVE_CALENDAR_EVENT)
                        .skipSendToOriginalEndpoint()
                        .to(mockSaveCalendarEventEndpoint);
                interceptSendToEndpoint(URI_GET_ENTITY_BY_UUID)
                        .skipSendToOriginalEndpoint()
                        .to(mockGetEntityByUuidEndpoint);
            }
        });
    }
    ...
    public void shouldSkipIfTheObsWasNotRecordedOnTheAssessmentOutComeGsFinalForm() throws Exception {
        ...
        mockObsCapturedOnFormEndpoint.expectedPropertyReceived(
                ObsCapturedOnFormRuleRouteTest.EX_PROP_FORM_UUID, FINAL_ASSMT_FORM_UUID);
    ...
    public void shouldSkipIfNoPhysioSessionEncounterIsFoundInTheVisit() throws Exception {
        ...
        params.put(GetMostRecentEncByFormInVisitRouteTest.PARAM_FORM_UUID, PHYSIO_FORM_UUID);
        params.put(GetMostRecentEncByFormInVisitRouteTest.PARAM_VISIT_UUID, visitUuid);
    ...
    public void shouldSkipIfNoPhysioServiceWasSelected() throws Exception {
        ...
        mockGetEntityByUuidEndpoint.expectedPropertyValuesReceivedInAnyOrder(
                EX_PROP_RESOURCE_NAME, "encounter", "encounter");
        mockGetEntityByUuidEndpoint.expectedPropertyValuesReceivedInAnyOrder(
                EX_PROP_RESOURCE_ID, encUuid, physioEncUuid);
        ...
        mockGetEntityByUuidEndpoint.whenExchangeReceived(
                2, e -> e.getIn().setBody(mapper.writeValueAsString(physioEncRes)));
    ...
    public void shouldSkipSelectedPhysioServiceThatHaveZeroSessions() throws Exception {
        ...
        params.put(GetMostRecentEncByFormInVisitRouteTest.PARAM_VISIT_UUID, visitUuid);
        mockGetMostRecentEncEndpoint.expectedBodiesReceived(params);
        mockGetMostRecentEncEndpoint.whenAnyExchangeReceived(
                e -> e.getIn().setBody(singletonMap("uuid", physioEncUuid)));
    ...
    public void shouldFailIfThePatientDoesNotExistInOpenmrs() throws Exception {
        ...
        mockGetEntityByUuidEndpoint.expectedPropertyValuesReceivedInAnyOrder(
                EX_PROP_IS_SUBRESOURCE, false, false, false);
        mockGetEntityByUuidEndpoint.expectedPropertyValuesReceivedInAnyOrder(
                EX_PROP_RESOURCE_NAME, "encounter", "encounter", "patient");
    ...
    public void shouldFailIfNoBillingGroupIsFoundMatchingTheSpecifiedExternalId() throws Exception {
        ...
        mockGetEntityByUuidEndpoint.expectedPropertyValuesReceivedInAnyOrder(
                EX_PROP_RESOURCE_NAME, "encounter", "encounter", "patient");
        mockGetEntityByUuidEndpoint.expectedPropertyValuesReceivedInAnyOrder(
                EX_PROP_RESOURCE_ID, encUuid, physioEncUuid, patientUuid);
        mockGetEntityByUuidEndpoint.expectedPropertyValuesReceivedInAnyOrder(EX_PROP_RES_REP, "full", "full", "full");
        mockGetEntityByUuidEndpoint.whenExchangeReceived(1, e -> e.getIn().setBody(mapper.writeValueAsString(encRes)));
        mockGetEntityByUuidEndpoint.whenExchangeReceived(
                2, e -> e.getIn().setBody(mapper.writeValueAsString(physioEncRes)));
    ...
    public void shouldCreateTheCalendarEventInOdoo() throws Exception {
        ...
        mockGetEntityByUuidEndpoint.whenExchangeReceived(
                2, e -> e.getIn().setBody(mapper.writeValueAsString(physioEncRes)));
        mockGetEntityByUuidEndpoint.whenExchangeReceived(
                3, e -> e.getIn().setBody(mapper.writeValueAsString(patientRes)));
        ...
        mockGetPartnersByUsersEndpoint.expectedBodiesReceived(
                singletonMap(GetPartnerIdsByUserIdsRouteTest.PARAM_USER_IDS, userIds));
        mockGetPartnersByUsersEndpoint.whenAnyExchangeReceived(e -> e.getIn()
                .setBody(asList(
                        singletonMap("partner_id", asList(partnerId1, "Partner 1")),
        ...
        final String expectedDescr = "Physiotherapy sessions for " + fullName + " " + hsuId + " - "
                + StringUtils.join(
                        asList(
                                indPre + " [" + countIndAt.intValue() + "]",
                                grpPre + " [" + countGrpPreAt.intValue() + "]",
                                grpPost + " [" + countGrpPostAt.intValue() + "]",
                                indNonAt + " [" + countIndNonAt.intValue() + "]",
                                grpOther + " [" + countGrpOther.intValue() + "]"),
                        ", ");
        ...
        mockSaveCalendarEventEndpoint.expectedPropertyReceived(
                EX_PROP_ATTENDEE_PARTNER_IDS, new ArrayList(asList(partnerId1, partnerId2)));
