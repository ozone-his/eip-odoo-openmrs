...
public class OdooPatientHandlerRouteTest extends BaseOdooRouteTest {
	...
	public void setup() throws Exception {
		...
		advise(ROUTE_ID, new AdviceWithRouteBuilder() {
			...
			public void configure() {
				...
				interceptSendToEndpoint("direct:callback-get-custom-customer-data").skipSendToOriginalEndpoint()
	...
	public void shouldFailIfThePatientHasMultipleCustomerRecordsInOdoo() throws Exception {
		...
		assertEquals("Found 2 existing customers in odoo with ref: " + OdooTestConstants.PATIENT_UUID, getErrorMessage(exchange));
	}
