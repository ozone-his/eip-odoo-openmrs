	...
	public void setup() throws Exception {
		...
		advise(ROUTE_ID, new AdviceWithRouteBuilder() {
			...
			public void configure() {
				interceptSendToEndpoint(OdooTestConstants.URI_GET_EXT_ID).skipSendToOriginalEndpoint().to(mockExtIdMapEndpoint);
				interceptSendToEndpoint(OdooTestConstants.URI_GET_QUOTES).skipSendToOriginalEndpoint().to(mockGetDraftQuotesEndpoint);
				interceptSendToEndpoint(OdooTestConstants.URI_MANAGE_QUOTE).skipSendToOriginalEndpoint().to(mockManageQuoteEndpoint);
				interceptSendToEndpoint(OdooTestConstants.URI_GET_LINE).skipSendToOriginalEndpoint().to(mockGetOrderLineEndpoint);
			}
