...
import static com.ozonehis.eip.route.GetResourceByIdFromOdooRouteTest.PARAM_ID;
import static com.ozonehis.eip.route.OdooTestConstants.PARAM_MODEL_NAME;
import static com.ozonehis.eip.route.OdooTestConstants.ROUTE_ID_GET_EXT_ID_MAP;
import static com.ozonehis.eip.route.OdooTestConstants.ROUTE_ID_GET_RES_BY_EXT_ID_FROM_ODOO;
import static com.ozonehis.eip.route.OdooTestConstants.ROUTE_ID_GET_RES_BY_ID_FROM_ODOO;
import static com.ozonehis.eip.route.OdooTestConstants.URI_GET_EXT_ID;
    ...
    public void setup() throws Exception {
        ...
        advise(ROUTE_ID_GET_RES_BY_EXT_ID_FROM_ODOO, new AdviceWithRouteBuilder() {
            ...
            public void configure() {
                interceptSendToEndpoint(URI_GET_EXT_ID)
                        .skipSendToOriginalEndpoint()
                        .to(mockGetExtIdMapEndpoint);
                interceptSendToEndpoint(URI_GET_RES_BY_ID_FROM_ODOO)
                        .skipSendToOriginalEndpoint()
