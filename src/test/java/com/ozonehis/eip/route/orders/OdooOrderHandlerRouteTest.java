...
import static com.ozonehis.eip.route.OdooTestConstants.ORDER_UUID_1;
import static com.ozonehis.eip.route.OdooTestConstants.ORDER_UUID_2;
...
import static com.ozonehis.eip.route.OdooTestConstants.URI_ORDER_HANDLER;
import static com.ozonehis.eip.route.OdooTestConstants.URI_PROCESS_ORDER;
    ...
    public void setup() throws Exception {
        ...
        advise(ROUTE_ID, new AdviceWithRouteBuilder() {
            ...
            public void configure() {
                ...
                interceptSendToEndpoint(URI_PROCESS_ORDER)
                        .skipSendToOriginalEndpoint()
